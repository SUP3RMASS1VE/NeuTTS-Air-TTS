...
class NeuTTSAir:
    ...
    def infer(self, text: str, ref_codes: np.ndarray | torch.Tensor, ref_text: str, seed: int | None = None) -> np.ndarray:
        """
        ...
        if self._is_quantized_model:
            output_str = self._infer_ggml(ref_codes, ref_text, text, seed)
        else:
    ...
    def _infer_ggml(self, ref_codes: list[int], ref_text: str, input_text: str, seed: int | None = None) -> str:
